...
export const manicLightTheme = {
  ...
  colors: {
    ...
    'diffEditor.insertedTextBackground': hexWithAlpha('#9ccc2c', 0.25),
    ...
    'editorGutter.deletedBackground': colors.scm.deleted,
    'editorGutter.deletedSecondaryBackground': hexWithAlpha(colors.scm.deleted, 0.45),
    'editorGutter.modifiedBackground': colors.scm.modified,
    'editorGutter.modifiedSecondaryBackground': hexWithAlpha(colors.scm.modified, 0.45),
