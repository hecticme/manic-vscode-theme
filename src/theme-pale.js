...
export const manicPaleTheme = {
  ...
  colors: {
    ...
    'editorGutter.addedBackground': colors.scm.added,
    'editorGutter.addedSecondaryBackground': hexWithAlpha(colors.scm.added, 0.5),
    'editorGutter.deletedBackground': colors.scm.deleted,
    'editorGutter.deletedSecondaryBackground': hexWithAlpha(colors.scm.deleted, 0.5),
    'editorGutter.modifiedBackground': colors.scm.modified,
    'editorGutter.modifiedSecondaryBackground': hexWithAlpha(colors.scm.modified, 0.5),
